...
KIND_KEYWORDS: tuple[tuple[SemanticKind, tuple[str, ...]], ...] = (
    ...
    (SemanticKind.INCIDENT, ("incident", "outage", "postmortem")),
...
class MarkdownCognitionExtractor:
    """Extracts first-class cognition objects from Markdown heading chunks."""
    ...
    def extract_file(self, file: FileObservation) -> tuple[SemanticObject, ...]:
        ...
        for chunk in chunks:
            ...
            confidence = Confidence(
                ...
                rationale=f"markdown heading/content matched {kind.value} cognition",
                evidence_count=1,
            )
            objects.append(
                SemanticObject(
